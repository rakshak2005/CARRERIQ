...
import rakshakImg from '../assets/rakshak.jpg';
import varshaImg from '../assets/varsha.jpg';
...
export const Home: React.FC = () => {
  ...
  useEffect(() => {
    ...
    styles.innerHTML = `
      ...
      .creator-card:hover {
        transform: translateY(-12px) scale(1.02) rotate(0.5deg) !important;
        border-color: rgba(75, 97, 235, 0.4) !important;
        box-shadow: 0 30px 80px rgba(75, 97, 235, 0.25) !important;
      }
      .creator-card::before {
        content: '';
        position: absolute;
      ...
      .creator-card:hover::before {
        opacity: 1;
        background: linear-gradient(135deg, #4b61eb, #8b5cf6, #10b981);
  ...
  return (
    <div className="min-h-screen relative overflow-hidden text-slate-800 dark:text-slate-100 transition-colors duration-500 font-sans">
      ...
      <main className="relative z-10">
        ...
        {/* Creators Section (Medium Size) */}
        <section className="py-20 px-6 max-w-[1000px] mx-auto border-t border-slate-200/50 dark:border-white/5 relative">
          
          <div className="text-center mb-12">
            <h2 className="text-3xl font-black text-slate-800 dark:text-white mb-3 font-['Outfit'] tracking-tight">
              The Minds Behind <span className="bg-gradient-to-r from-[#4b61eb] via-[#8b5cf6] to-[#10b981] bg-clip-text text-transparent">CareerIQ</span>
            </h2>
            <p className="text-slate-500 dark:text-slate-400 text-xs md:text-sm max-w-xl mx-auto leading-relaxed font-semibold">
              Meet the engineers and designers crafting intelligent verification and career acceleration platforms.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            {/* Rakshak */}
            <div className="creator-card p-6 flex flex-col sm:flex-row items-center gap-6">
              <div className="relative group/img flex-shrink-0">
                <div className="absolute inset-0 bg-gradient-to-tr from-[#4b61eb] to-emerald-400 rounded-2xl blur-sm opacity-30 group-hover/img:opacity-50 transition-all duration-300" />
                <img 
                  src={rakshakImg} 
                  alt="Rakshak Patel V" 
                  className="w-24 h-24 rounded-2xl object-cover object-top border border-white/10 relative z-10" 
                />
              </div>
              <div className="flex-1 text-left flex flex-col justify-between h-full">
                <div>
                  <div className="flex items-center gap-1.5 mb-1">
                    <h3 className="font-extrabold text-lg text-slate-800 dark:text-white leading-tight">Rakshak Patel V</h3>
                    <span className="text-emerald-500 text-xs font-bold" title="Verified Developer Account">✔</span>
                  </div>
                  <p className="text-xs font-bold text-[#4b61eb] dark:text-[#9bb2ff] uppercase tracking-wider mb-2 text-left">Co-Founder & Full Stack Developer</p>
                  <p className="text-slate-550 dark:text-slate-300 text-xs leading-relaxed mb-3 text-left">
                    Building scalable AI-powered career platforms using React, Node.js, MongoDB, and modern cloud architecture.
                  </p>
                  {/* Inline Stats/Context */}
                  <div className="flex flex-wrap gap-2 text-[10px] text-slate-400 font-semibold mb-4 justify-start">
                    <span className="bg-white/5 px-2 py-0.5 rounded-md">🎓 AMC College</span>
                    <span className="bg-white/5 px-2 py-0.5 rounded-md">💼 Amilo AI</span>
                    <span className="bg-white/5 px-2 py-0.5 rounded-md">📍 Bangalore</span>
                  </div>
                </div>
                
                {/* Social icons */}
                <div className="flex items-center gap-3 justify-start">
                  <a href="https://www.linkedin.com/in/rakshak-patel-v-12b2b624a" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-[#0a66c2] hover:bg-[#0a66c2]/10 transition-colors">
                    <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.779-1.75-1.75s.784-1.75 1.75-1.75 1.75.779 1.75 1.75-.784 1.75-1.75 1.75zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                  </a>
                  <a href="https://github.com/rakshak2005" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-white hover:bg-white/10 transition-colors">
                  ...
                  <a href="mailto:rakshakpatel2005@gmail.com" className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-red-500 hover:bg-red-500/10 transition-colors">
            ...
            <div className="creator-card p-6 flex flex-col sm:flex-row items-center gap-6">
              <div className="relative group/img flex-shrink-0">
                <div className="absolute inset-0 bg-gradient-to-tr from-[#8b5cf6] to-pink-400 rounded-2xl blur-sm opacity-30 group-hover/img:opacity-50 transition-all duration-300" />
                <img 
                  src={varshaImg} 
                  alt="Varsha Gowda" 
                  className="w-24 h-24 rounded-2xl object-cover object-top border border-white/10 relative z-10" 
              ...
              <div className="flex-1 text-left flex flex-col justify-between h-full">
                <div>
                  <div className="flex items-center gap-1.5 mb-1">
                    <h3 className="font-extrabold text-lg text-slate-800 dark:text-white leading-tight">Varsha Gowda</h3>
                    <span className="text-purple-500 text-xs font-bold" title="Verified Product Architect">✔</span>
                  </div>
                  <p className="text-xs font-bold text-[#8b5cf6] uppercase tracking-wider mb-2 text-left">Co-Founder & Product Designer</p>
                  <p className="text-slate-500 dark:text-slate-300 text-xs leading-relaxed mb-3 text-left">
                    Designing intuitive user experiences, premium aesthetics, and responsive layout architectures for modern SaaS applications.
                  </p>
                  {/* Inline Stats/Context */}
                  <div className="flex flex-wrap gap-2 text-[10px] text-slate-400 font-semibold mb-4 justify-start">
                    <span className="bg-white/5 px-2 py-0.5 rounded-md">🎓 AMC College</span>
                    <span className="bg-white/5 px-2 py-0.5 rounded-md">💼 CareerIQ</span>
                    <span className="bg-white/5 px-2 py-0.5 rounded-md">📍 Bangalore</span>
                  </div>
                </div>
                ...
                {/* Social icons */}
                <div className="flex items-center gap-3 justify-start">
                  <a href="https://www.linkedin.com/in/varsha-gowda-00713725b" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-[#0a66c2] hover:bg-[#0a66c2]/10 transition-colors">
                    <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.779-1.75-1.75s.784-1.75 1.75-1.75 1.75.779 1.75 1.75-.784 1.75-1.75 1.75zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                  </a>
                  <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-white hover:bg-white/10 transition-colors">
                    <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg>
                  </a>
                  <a href="mailto:varsha.gowda@careeriq.com" className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center text-red-500 hover:bg-red-500/10 transition-colors">
                    <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>
                  </a>
                </div>
              </div>
